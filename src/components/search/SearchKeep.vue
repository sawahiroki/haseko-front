<template>
  ...
  <b-nav tabs fill>
    <b-nav-item to="/search/properties">検索結果一覧</b-nav-item>
    ...
    <br><br>
    <SearchPropertyView id="properties-list" :propertyNum="i" :property="keepProperties[i]" v-for="i of idList" :key="i" />
    <br>
    <b-pagination
      v-model="currentPage"
      :total-rows="rows"
